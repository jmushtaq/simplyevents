...
# Import abstract models from this app
...
if not is_model_registered("order", "HirePeriod"):

    class HirePeriod(AbstractHirePeriod):
        pass

    __all__.append("HirePeriod")


if not is_model_registered("order", "GuestHireSession"):

    class GuestHireSession(AbstractGuestHireSession):
        pass

    __all__.append("GuestHireSession")
