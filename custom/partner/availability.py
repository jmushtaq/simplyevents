...
class StockRequired(Base):
    ...
    def message(self) -> str:
        ...
        """
        if self.num_available > 0:
            return _("Available (%d available)") % self.num_available
        return _("Unavailable")


class HireAvailability(StockRequired):
    """
    Availability policy for hire products - uses Available/Unavailable terminology
    """
    ...
    def message(self) -> str:
        if self.num_available > 0:
            return _("Available for hire (%d available)") % self.num_available
        return _("Unavailable for hire")
