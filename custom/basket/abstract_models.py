...
class AbstractLine(models.Model):
    ...
    # Hire period fields - for event hire system
    hire_start_date = models.DateTimeField(
        _("Hire Start Date"),
        null=True,
        blank=True,
        help_text=_("Start date of hire period (Thursday 5pm)")
    )
    hire_end_date = models.DateTimeField(
        _("Hire End Date"),
        null=True,
        blank=True,
        help_text=_("End date of hire period (Monday 7pm)")
    )
